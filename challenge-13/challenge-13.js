(function () {
  ...
  */
  ...
  chamada `newSudeste`.
  */
  var newSudeste = brasil.filter(function (item) {
    return sudeste.includes(item);
  });
  ...
  */
  ...
  var verifyLength = brasil.every(function (item) {
