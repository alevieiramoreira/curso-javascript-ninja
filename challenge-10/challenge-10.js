(function(){
    ...
    */
    function showOperationMessage( operator, a, b ){
        console.log( `A operação ${a} ${operator} ${b} = ` )
    }
    /*
    ...
    */
    function showErrorMessage(){
        connsole.log( `Operação ${operator} não permitida!` )  
    }
    ...
    */
    ...
    console.log( showOperationMessage( sum(), number1, number2 ), sum( number1, number2 ) );
    /*
