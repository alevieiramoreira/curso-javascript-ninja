...
*/
  ...
  console.log(text.replace(/Manuel Marques de Souza/g, 'Alessandra Moreira'));
...
*/
  ...
  console.log(
    text.replace(/O Centauro de Luvas/, (text) => {
...
*/
  ...
  function getMonthNumber(monthName) {
    ...
    let [newMonth] = months.filter((month) => month.name === monthName);

    return newMonth.value;
  }
